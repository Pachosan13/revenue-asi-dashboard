...
-- Archivo sugerido: 20251206_add_lead_enrichments_v2.sql
...
declare
  v_event_id uuid;
begin
  -- Sólo cuando pasamos a COMPLETED y aún no hay evento registrado
...
begin
  ...
  -- AUTO: intenta reusar último COMPLETED
  if p_mode = 'auto' then
    select *
    into v_run
